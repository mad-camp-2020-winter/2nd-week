module.exports = function(app, Institution)
{
    ...
    app.get('/institution/name/:name', function(req, res){
        Institution.find({name: req.params.name}, {_id: 0, name: 1, number: 1, location: 1},  function(err, institutions){
            if(err) return res.status(500).json({error: err});
    ...
    app.put('/institutions/:institution_id', function(req, res){
    ...
    */
    ...
    // DELETE INSTITUTION
    app.delete('/institutions/:institution_id', function(req, res){
